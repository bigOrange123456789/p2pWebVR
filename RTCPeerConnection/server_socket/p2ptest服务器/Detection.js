...
class Detection {//需要服务器
    constructor(userID) {
        ...
        if(typeof this.needDetection==="undefined")this.needDetection=false
        ...
        this.userID=userID//prompt("请输入您的学号：")
    ...
    finish(){
        ...
        console.log(window.param.dectionURL,JSON.stringify(data))
