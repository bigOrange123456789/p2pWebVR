...
class MakeOneRoamStep{
    ...
    updateParam(x1,y1,z1,x2,y2,z2,a1,b1,c1,a2,b2,c2,time){
        var scope=this;
    ...
    initParam(x1,y1,z1,x2,y2,z2,a1,b1,c1,a2,b2,c2,time){
        var scope=this;
        scope.stepIndex_max=time;
        scope.updateParam(x1,y1,z1,x2,y2,z2,a1,b1,c1,a2,b2,c2,time);
    }
    preview(mystate,avatar,mydata){//thisObj,time,myavatar,k//thisObj,x1,y1,z1,x2,y2,z2,time,myavatar,k
        var scope=this;
...
class MoveManager{
    ...
    constructor(avatar,roamPath){
        ...
        scope.stopFlag=true;
        scope.isLoop=true;//如果不进行循环漫游的话，第一行的初始状态就没用了
