...
},{}],"lib/myThree/RTCMultiConnection.min.js":[function(require,module,exports) {
...
var RTCMultiConnection = function RTCMultiConnection(roomid, forceOptions) {
  ...
  function isAudioPlusTab(connection, audioPlusTab) {
    return (!connection.session.audio || "two-way" !== connection.session.audio) && ("Firefox" === DetectRTC.browser.name && audioPlusTab !== !1 || !("Chrome" !== DetectRTC.browser.name || DetectRTC.browser.version < 50) && (_typeof(audioPlusTab) === !0 || !("undefined" != typeof audioPlusTab || !connection.session.audio || !connection.session.screen || connection.session.video) && (audioPlusTab = !0, !0)));
  }
    ...
    if (currentUserMediaRequest.streams[idInstance]) streaming(currentUserMediaRequest.streams[idInstance].stream, !0);else {
      ...
      if ("undefined" == typeof navigator.mediaDevices) {
        ...
        var getUserMediaStream,
            getUserMediaError,
            getUserMediaSuccess = function getUserMediaSuccess() {},
            getUserMediaFailure = function getUserMediaFailure() {};
  ...
  !function (that) {
    ...
    var browserFakeUserAgent = "Fake/5.0 (FakeOS) AppleWebKit/123 (KHTML, like Gecko) Fake/12.3.4567.89 Fake/123.45",
        isNodejs = "object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && "object" == _typeof(process.versions) && process.versions.node && !true;
    ...
    var isNodejs = "object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && "object" == _typeof(process.versions) && process.versions.node;
    ...
    var isWebRTCSupported = ("object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && "object" == _typeof(process.versions) && process.versions["node-webkit"], !1);
  ...
  !function (connection) {
    ...
    function joinRoom(connectionDescription, cb) {
      connection.socket.emit("join-room", {
        ...
        password: "undefined" != typeof connection.password && "object" != _typeof(connection.password) ? connection.password : ""
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lib/myThree/RTCMultiConnection.min.js"], null)
//# sourceMappingURL=/RTCMultiConnection.min.2371ef2f.js.map